...
namespace UniDef.Migrations
{
    ...
    [Migration("20200602103317_Studying")]
    partial class Studying
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniDef.Asistentes.Asistente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("UsuarioAsistenteId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("UniDef.Eventos.Evento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("UsuarioOrganizadorId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("UniDef.Seguidores.Seguidor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("UniDef.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("UniDef.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("UniDef.Asistentes.Asistente", b =>
                {
                    b.HasOne("UniDef.Eventos.Evento", "Evento")
            ...
            modelBuilder.Entity("UniDef.Eventos.Evento", b =>
                {
                    b.HasOne("UniDef.Authorization.Users.User", "UsuarioOrganizador")
            ...
            modelBuilder.Entity("UniDef.Seguidores.Seguidor", b =>
                {
                    b.HasOne("UniDef.Authorization.Users.User", "UsuarioSeguido")
                        .WithMany("UsuariosSeguidos")
                        .HasForeignKey("UsuarioSeguidoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("UniDef.Authorization.Users.User", "UsuarioSeguidor")
