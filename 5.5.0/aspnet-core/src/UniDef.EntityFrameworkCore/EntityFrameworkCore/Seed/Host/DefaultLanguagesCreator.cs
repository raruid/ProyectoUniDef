...
namespace UniDef.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly UniDefDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = UniDefConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(UniDefDbContext context)
        {
            _context = context;
        }
