...
{
    public abstract class UniDefWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UniDefWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UniDefWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UniDefDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UniDefDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UniDefDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UniDefDbContext, Task<T>> func)
        {
            T result;
